...
class Inventory extends Controller {
    ...
    public function medicineStore() {
        ...
        $medicineId = $model->insert('medicines', [
            ...
            'buy_price' => parse_money_input($this->input('buy_price', 0)),
            'sell_price' => parse_money_input($this->input('sell_price', 0)),
    ...
    public function stockIn() {
        ...
        $movementId = $model->insert('stock_movements', [
            ...
            'reference_id' => null,
            'qty' => $this->input('qty'),
            'unit_cost' => parse_money_input($this->input('unit_cost', 0)),
